...
bg.resize((1466, 850),Image.NEAREST)
bg_img = ImageTk.PhotoImage(bg)
bg_lbl = tk.Label(root,image=bg_img)
bg_lbl.place(x=170,y=110)
               ...
               ms.showinfo('Error!', 'This Text File Already Exist !')
                ...
                with conn:
                    ...
                    def onClickDecrypt():
                        ...
                        print(cipher1)
                        '''fh = open("cipher_decrypt_text.txt", "w",encoding="utf-8")
                        fh.write(cipher)
                        fh.close()'''
                    ...
                    def onClickEncrypt():
                        ...
                        # fh = open("cipher_encrpt_text.txt", "w",encoding="utf-8")
                        # fh.write(cipher)
                        # fh.close()
                    ...
                    # l2 = tk.Label(frame, text="Enter Key :", width=12, font=("Times new roman", 15, "bold"), bg="antiquewhite2",bd=5)
                    # l2.place(x=30, y=30)
                    # t1 = tk.Entry(frame, textvar=new_key, width=20, font=('', 15),show='*',bd=5)
                    # t1.place(x=230, y=30)
...
# wlcm=tk.Label(root,text="......Welcome to IMAGE AND TEXT ENCRYPTION ......",width=85,height=1,background="skyblue",foreground="black",font=("Times new roman",22,"bold"))
